    ...
    I: Iterator<Item = u32>,
{
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        // ⚡ Bolt Optimization: Replaced explicit piped numbers with inclusive range bounds and
        // removed mathematically redundant `& 0xF` mask. This reduces branch generation and eliminates
        // an unnecessary bitwise instruction, improving stream evaluation time.
        match w1 >> 28 {
